...
<div id="sidebar" class="sidebar responsive">
    ...
    <ul class="nav nav-list">
        ...
        <li class="customer">
            <a href='<c:url value="/admin-account?type=list"/>' style="cursor: pointer; pointer-events: all;"
        ...
        <li class="brand"><a href='<c:url value="/admin-category?type=list"/>' style="cursor: pointer;">
            <i class="far fa-image menu-icon"></i>
            <span style="font-family: Arial, Helvetica, sans-serif;"
                  class="menu-text"> Category </span>
        </a> <b class="arrow"></b></li>

        <li class="product"><a href='<c:url value="/admin-product?type=list"/>' style="cursor: pointer;"
