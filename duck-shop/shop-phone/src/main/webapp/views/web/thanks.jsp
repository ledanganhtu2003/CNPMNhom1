        ...
        <div class="content__container  ">
            <div class="thank">
                <div class="thank__content">
                    ...
                    <p style="margin-bottom: 1rem;">Nhân viên Shopdunk sẽ liên hệ cho Quý Khách để xác nhận đơn hàng</p>
                    <p style="font-size: 1.4rem;" >Mọi thắc mắc vui lòng liên hệ 18008888 hoặc 18009999</p>
                </div>
