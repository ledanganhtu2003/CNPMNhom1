        ...
        <div class="account">
            ...
            <div class="account__right">
                <div class="account-info-container">
                    <form class="account-form show" data-form="1" id="form-profile"
                          onsubmit="btnUpdateUser.disabled = true; return true;">
                        <p>Thông tin tài khoản</p>
                        <div class="form-group">
                            <label for="fullName">Họ và tên</label>
                            <input type="text" name="fullName" id="fullName" value="${USERMODEL.fullName}"
                                   required="required">
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" value="${USERMODEL.email}" required="required"
                                   readonly="readonly">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="address" id="address" value="${USERMODEL.address}"
                                   required="required">
                        </div>
                        <div class="form-group">
