                ...
                <form id="formSubmit" class="form form-singup">
                    ...
                    <div class="form__group">
                        <div class="form__item">
                            ...
                            <input type="text" name="fullName" id="fullName" value="" class="form__input"
                                   required="required">
                        </div>
                        <div class="form__item">
                            <label for="email">Email</label>
                            <input type="email" name="email" id="email" value="" class="form__input"
                                   required="required">
                        </div>
                        <div class="form__item">
                        ...
                        <div class="form__item">
                            ...
                            <input type="text" name="address" id="address" value="" class="form__input"
                                   required="required">
                        </div>
                        <div class="form__item">
                            <label for="password">Mật khẩu</label>
                            <input type="password" name="password" id="password" value="" class="form__input"
                                   required="required">
                        </div>
                    </div>
